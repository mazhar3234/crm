...
<div class="app-main__inner">
    ...
    {{ Form::open(['route'=>'update-location.post', 'id'=>'signupForm', 'novalidate']) }}
        <!-- content area -->
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="form-section col-md-8 col-sm-8 col-12">
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="location_name" id="location_name" placeholder="Location name" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('location_name')) is-invalid @endif" value="{{ $location->location_name }}" required minlength="2">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="location_name_rus" id="location_name_rus" placeholder="Location name russain" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('location_name_rus')) is-invalid @endif" value="{{ $location->location_name_rus }}" required minlength="2">
