...
<div class="app-main__inner">
    ...
    <!-- subtitle -->
    {{ Form::open(['route'=>'update-vehicle.post', 'enctype'=>'multipart/form-data', 'id'=>'signupForm', 'novalidate']) }}
        <div class="app-page-title page-subtitle" id="page-subtitle">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>
                        <div class="page-title-subheading pl-1">
                            Edit car with all required information.
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row pb-4">
                        <div class="info-section col-md-4 col-sm-4 col-12">
                            ...
                            <p class="info-subtitle">
                                <figure>
                                    @if($vehicle->image)
                                    <img src="{{ asset('backend/images/vehicles/'.$vehicle->image) }}" width="130" height="130" class="rounded-circle" id="img_prev">
                                    @else
                        ...
                        <div class="form-section col-md-8 col-sm-8 col-12">
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="vehicle_class_id" id="vehicle_class_id" class="form-control custom-form-contorl form-control-sm @if($errors->first('vehicle_class_id')) is-invalid @endif" required>
                                        ...
                                        <option @if($class->id == $vehicle->vehicle_class_id) selected @endif value="{{ $class->id }}">{{ $class->class_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="vehicle_name" id="vehicle_name" placeholder="Vehicle name" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('vehicle_name')) is-invalid @endif" value="{{ $vehicle->vehicle_name }}" required minlength="3">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="registration_no" id="registration_no" placeholder="Registration number" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('registration_no')) is-invalid @endif" value="{{ $vehicle->registration_no }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="fuel_type" id="fuel_type" class="form-control custom-form-contorl form-control-sm @if($errors->first('fuel_type')) is-invalid @endif" required>
                                        @if($vehicle->fuel_type == 'Liquid air')
                                        <option selected>Liquid air</option>
                                        <option>Gas</option>
                                        <option>Petrol</option>
                                        <option>Diesel</option>
                                        @elseif($vehicle->fuel_type == 'Gas')
                                        <option>Liquid air</option>
                                        <option selected>Gas</option>
                                        <option>Petrol</option>
                                        <option>Diesel</option>
                                        @elseif($vehicle->fuel_type == 'Petrol')
                                        <option>Liquid air</option>
                                        <option>Gas</option>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="seats" id="seats" placeholder="Seats" type="number" class="form-control custom-form-contorl form-control-sm @if($errors->first('seats')) is-invalid @endif" value="{{ $vehicle->seats }}">
                    ...
                    <div class="row pb-4">
                        <div class="info-section col-md-4 col-sm-4 col-12">
                            ...
                            <p class="info-subtitle">
                                <figure>
                                    @if($vehicle->driver->image)
                                    <img src="{{ asset('backend/images/drivers/'.$vehicle->driver->image) }}" width="130" height="130" class="rounded-circle" id="img_prev2">
                                    @else
                        ...
                        <div class="form-section col-md-8 col-sm-8 col-12">
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="driver_name" id="driver_name" placeholder="Full name" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('driver_name')) is-invalid @endif" value="{{ $vehicle->driver->driver_name }}" required minlength="3">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="email" id="email" placeholder="Email" type="email" class="form-control custom-form-contorl form-control-sm @if($errors->first('email')) is-invalid @endif" value="{{ $vehicle->driver->email }}" required minlength="3">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <select multiple name="language[]" id="language" class="form-control custom-form-contorl form-control-sm multiselect-dropdown">
                                        @foreach(explode(',', $vehicle->driver->language) as $lang)
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="4" name="description" id="description" placeholder="include description" class="form-control custom-form-contorl form-control-sm" required minlength="50">{{ $vehicle->driver->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-section col-md-8 col-sm-8 col-12">
                            <div class="row">
                                ...
                                <div class="position-relative form-group col-md-4">
                                    ...
                                    <input name="amount_usd[]" id="amount_usd" placeholder="USD" type="number" class="form-control custom-form-contorl form-control-sm" required value="{{$price->amount_usd}}">
                                </div>
                                <div class="position-relative form-group col-md-4">
                                    <label for="amount_gel" class="col-form-label custom-label">
                                        Default Amount (GEL)
                                    </label>
                                    <input name="amount_gel[]" id="amount_gel" placeholder="GEL" type="number" class="form-control custom-form-contorl form-control-sm" required value="{{$price->amount_gel}}">
                                </div>
                                <div class="position-relative form-group col-md-4">
                                    <label for="amount_rub" class="col-form-label custom-label">
                                        Default Amount (RUB)
                                    </label>
                                    <input name="amount_rub[]" id="amount_rub" placeholder="RUB" type="number" class="form-control custom-form-contorl form-control-sm" required value="{{$price->amount_rub}}">
                                </div>
                            </div>
                            <?php $add = ''; $remove = 'none'; ?>
                            ...
                            <div class="row" id="cloneDiv">
                                <div class="position-relative form-group col-md-3">
                                    <label style="font-size: 12px;" for="from_km" class="col-form-label custom-label">
                                        From KM
                                    </label>
                                    <input name="from_km[]" placeholder="From Km" type="number" class="form-control custom-form-contorl form-control-sm" value="{{$data->from_km}}">
                                </div>
                                <div class="position-relative form-group col-md-2">
                                    <label style="font-size: 12px;" for="to_km" class="col-form-label custom-label">
                                        To KM
                                    </label>
                                    <input name="to_km[]" placeholder="To Km" type="number" class="form-control custom-form-contorl form-control-sm" value="{{$data->to_km}}">
                                </div>
                                <div class="position-relative form-group col-md-2">
                                    <label style="font-size: 12px;" for="amount_usd" class="col-form-label custom-label">
                                        Amount (USD)
                                    </label>
                                    <input name="amount_usd[]" id="amount_usd" placeholder="USD" type="number" class="form-control custom-form-contorl form-control-sm" value="{{$data->amount_usd}}">
                                </div>
                                <div class="position-relative form-group col-md-2">
                                    <label style="font-size: 12px;" for="amount_gel" class="col-form-label custom-label">
                                        Amount (GEL)
                                    </label>
                                    <input name="amount_gel[]" id="amount_gel" placeholder="GEL" type="number" class="form-control custom-form-contorl form-control-sm" value="{{$data->amount_gel}}">
                                </div>
                                <div class="position-relative form-group col-md-2">
                                    <label style="font-size: 12px;" for="amount_rub" class="col-form-label custom-label">
                                        Amount (RUB)
                                    </label>
                                    <input name="amount_rub[]" id="amount_rub" placeholder="RUB" type="number" class="form-control custom-form-contorl form-control-sm" value="{{$data->amount_rub}}">
                                </div>
