...
<div class="app-main__inner">
    ...
    {{ Form::open(['route'=>'save-vehicle-class.post', 'id'=>'signupForm', 'novalidate']) }}
        <!-- content area -->
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="form-section col-md-8 col-sm-8 col-12">
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="class_name" id="class_name" placeholder="Class name" type="text" class="form-control custom-form-contorl form-control-sm @if($errors->first('class_name')) is-invalid @endif" value="{{ old('class_name') }}" required minlength="2">
